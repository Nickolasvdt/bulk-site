...
const SOCIALS = [
  {
    name: "Instagram",
    href: "https://instagram.com/studio.bulk",
          ...
          <div className="flex items-center gap-3">
            {SOCIALS.map((s) => (
              <a
                ...
                className="w-10 h-10 rounded-full border border-bg/20 flex items-center justify-center text-bg/60 hover:border-accent hover:text-accent hover:bg-accent/10 transition-colors"
              >
